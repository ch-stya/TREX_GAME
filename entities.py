...
import pygame
from config import RED_COLOR, SCREEN_WIDTH, SCREEN_HEIGHT, GROUND_MARGIN, GROUND_Y
...
class Player:
    def __init__(self, width=10, height=20, color=RED_COLOR):
        ...
        self.rect = pygame.Rect(
            ...
            GROUND_Y - height, # y, sur le sol et en déduisant la taille de l'objet car coord x,y se trouvent en haut à gauche
            self.width, # width
            self.height) # height
        self.gravity = 0
